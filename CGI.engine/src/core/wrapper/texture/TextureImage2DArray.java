...
public class TextureImage2DArray extends GLTexture{

	public TextureImage2DArray(int width, int height, int layers, ImageFormat imageFormat){
	...
	public TextureImage2DArray(int width, int height, int layers,
